...
class CustomTextImageDataModule(LightningDataModule):
    ...
    def add_argparse_args(parent_parser):
        ...
        parser.add_argument('--filter_description', type=bool, default=True, help='Use only description as text')
        return parser
    
    def setup(self, stage = None):
        self.dataset = CustomTextImageDataset(data_dir=self.data_dir, 
